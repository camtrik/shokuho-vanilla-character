...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <!-- Ensure Ii Naotora is treated as female and uses female equipment -->
  <xsl:template match="NPCCharacter[@id='lord_1_ii']">
    <xsl:copy>
      <xsl:copy-of select="@*[name()!='is_female' and name()!='voice']" />
